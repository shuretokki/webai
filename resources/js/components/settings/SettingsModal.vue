            ...
            <div class="flex-1 bg-background p-6 overflow-y-auto custom-scrollbar">
                ...
                <div v-if="activeTab === 'account'"
                    ...
                    <div
                        ...
                        <div
                            class="size-12 rounded-full border border-primary/30 flex items-center justify-center bg-primary/10 mb-2">
                ...
                <div v-if="activeTab === 'behavior'"
                    class="space-y-1 animate-in fade-in slide-in-from-right-4 duration-300">
                    <!-- Setting Item -->
                    <div
                        class="flex items-center justify-between py-3 px-2 hover:bg-white/5 transition-colors rounded-none">
                    ...
                    <div
                        ...
                        <button disabled
                            ...
                            <span
                                class="translate-x-1 inline-block size-4 transform rounded-full bg-white/50 shadow-sm"></span>
                        </button>
                    </div>
                    <div
                        class="flex items-center justify-between py-3 px-2 hover:bg-white/5 transition-colors rounded-none opacity-60">
