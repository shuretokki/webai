    ...
    <Motion v-bind="$attrs" :class="[
        ...
        <div class="w-full shrink-0 flex flex-col flex-1 gap-1 overflow-y-auto overflow-x-hidden px-4 custom-scrollbar">
            ...
            <Modal :show="showDeleteModal" title="Delete Chat" @close="showDeleteModal = false" max-width="sm"
                ...
                <div class="flex flex-col gap-6 p-1">
                    <div class="flex items-start gap-4">
                        <div
                            class="size-10 rounded-full bg-destructive/10 border border-destructive/20 flex items-center justify-center shrink-0">
            ...
            <Modal :show="showEditModal" title="Edit Chat Title" @close="showEditModal = false"
                ...
                <div class="flex flex-col gap-6 p-1">
                    <div class="space-y-2">
                        <label class="block text-xs font-space text-muted-foreground uppercase tracking-widest mb-2">Chat
                            Title</label>
