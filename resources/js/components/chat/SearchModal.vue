                    ...
                    <div v-if="isOpen"
                        ...
                        <div class="max-h-[60vh] overflow-y-auto">
                            ...
                            <div v-else class="py-2">
                                <button v-for="(result, index) in results" :key="result.id" type="button"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-baseline justify-between gap-2 mb-1">
                                            ...
                                            <span
                                                class="text-xs text-white/40 shrink-0 capitalize">{{ result.type }}</span>
                                        </div>
                        ...
                        <!-- Footer -->
                        <div
                            class="px-4 py-2 border-t border-white/10 bg-white/5 flex items-center justify-between text-xs text-white/40">
