        ...
        <div class="flex flex-col gap-6">
            <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
                ...
                <div class="grid gap-6">
                    ...
                    <Button type="submit"
                        class="w-full rounded-none bg-primary text-primary-foreground hover:bg-primary/90 font-medium"
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="/auth/github/redirect"
                    class="flex items-center justify-center gap-2 px-4 py-2 border border-transparent bg-[#24292e] hover:bg-[#24292e]/90 transition-all text-sm font-medium text-white rounded-none">
                    <Github class="size-4 text-white" />
                    GitHub
                </a>
                <a href="/auth/google/redirect"
                    class="flex items-center justify-center gap-2 px-4 py-2 border border-transparent bg-white hover:bg-gray-100 transition-all text-sm font-medium text-gray-900 rounded-none">
