...
export const ui = {
  ...
  layout: {
    ...
    pricingButton: 'w-full h-8 flex items-center justify-center rounded-full bg-white text-black font-medium text-[13px] hover:bg-neutral-200 transition-colors active:scale-[0.98]',
  },
  typography: {
